...
module LicenseFinder
  class Configuration
    ...
    extend Forwardable
    def_delegator :project_finder, :paths_to_scan
    def_delegator :options, :project_path
    ...
    #   new(primary_config, saved_config, project_path)
    # end
    #
    # def initialize(primary_config, saved_config, project_path)
